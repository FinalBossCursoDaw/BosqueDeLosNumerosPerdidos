...
<head>
    ...
    <title>@yield('title', 'El Bosc Dels Números Perduts')</title>
        ...
        <nav class="flex items-center justify-between px-8 h-full relative z-10">
            ...
            <ul class="flex gap-20 text-yellow-400 text-3xl">
                <li class="transform hover:scale-110 transition-all duration-300">
                    <a href="{{ route('home.ca') }}" class="hover:text-[#FED32C] transition-all text-stroke relative group">
                        Inici
    ...
    <script>
        ...
        window.addEventListener('scroll', function() {
            ...
            if (scrollTop > lastScrollTop && scrollTop > 100) {
                // Baixant - ocultar header
                header.style.transform = 'translateY(-100%)';
            } else {
                // Pujant - mostrar header
        ...
        function changeLanguage(lang) {
            ...
            // Aquí pots implementar la lògica de canvi d'idioma
        }
    </script>
</body>
</html>
